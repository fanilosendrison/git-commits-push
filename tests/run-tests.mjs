...
export const EXPECTED_NODE_TEST_FILES = Object.freeze([
	...
	"acceptance/a3-validation-repair-bounds.test.ts",
	"acceptance/a4-reconciliation-admission.test.ts",
	"acceptance/a5-v3-full-pipeline.test.ts",
	"acceptance/a6-push-only-recovery.test.ts",
	"concurrency/c1-cold-start-contention.test.ts",
	"concurrency/c2-finish-request-race.test.ts",
	"concurrency/c3-crashed-owner.test.ts",
	"concurrency/c4-orphan-recovery-contention.test.ts",
	...
	"unit/commit-message-repair.test.ts",
	"unit/commit-message-validator.test.ts",
	"unit/discovery.test.ts",
	"unit/error-classifier.test.ts",
	"unit/errors.test.ts",
	"unit/execution-boundary-process.test.ts",
	"unit/execution-control-protocol.test.ts",
	"unit/fallback-model.test.ts",
	"unit/feedback-formatter.test.ts",
	"unit/git-process-config.test.ts",
	"unit/git-publisher-v2.test.ts",
	"unit/git-publisher-validation.test.ts",
	"unit/git-publisher.test.ts",
	"unit/git-publisher-multi-commit.test.ts",
	"unit/historical-turnlock-state.test.ts",
	"unit/legacy-queue-state.test.ts",
	"unit/orchestrator-schema.test.ts",
	"unit/post-commit-push-recovery.test.ts",
	"unit/pre-commit-validators.test.ts",
	"unit/push-destination.test.ts",
	"unit/push-diagnostic-sanitizer.test.ts",
	"unit/push-endpoint-freeze.test.ts",
	"unit/push-endpoint.test.ts",
	"unit/push-only.test.ts",
	"unit/push-publication.test.ts",
	"unit/queue-retry.test.ts",
	"unit/queue-retry-history.test.ts",
	"unit/reconciler-active-execution.test.ts",
	"unit/reconciler-db.test.ts",
	"unit/reconciler-execution-invariants.test.ts",
	"unit/reconciler-heartbeat.test.ts",
	"unit/reconciler-preflight-read-only.test.ts",
	"unit/reconciler-registration-validation.test.ts",
	"unit/reconciler.test.ts",
	"unit/reporter-v2.test.ts",
	"unit/reporter.test.ts",
	"unit/request-identity.test.ts",
