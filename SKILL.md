...
**Immediately scan the working directory for uncommitted changes**
(`git status`). If changes exist, read the diff, craft the appropriate
commit message(s), stage, commit, and push — without waiting for the
user to ask.
